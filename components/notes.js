  ...
  return (
    <div>
      ...
      <div className='mt-10' style={{ display: 'flex', flexDirection: 'row' }}>
        {isSidebarOpen && (
          <div  className='ml-3 px-3 rounded-xl bg-[#C0B9DD]' style={{ height: '1000px', width: '250px', background: '' }}>
        ...
        <div style={{ flex: 1, marginLeft: isSidebarOpen ? '20px' : '0', transition: 'margin 0.2s' }}>
